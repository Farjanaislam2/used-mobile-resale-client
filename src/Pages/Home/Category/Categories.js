...
const {data : myProducts =[],isLoading } = useQuery({
  queryKey: ["categories"],
  queryFn: async() =>{
    const res =await  fetch("https://used-product-resale-market-server.vercel.app/categories");
...
if(isLoading){
  ...
  // useEffect(() => {
  //   fetch("https://used-product-resale-market-server.vercel.app/categories")
  //     .then((res) => res.json())
